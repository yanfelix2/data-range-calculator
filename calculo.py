def calcular_amplitude(dados):
    # Inicializa as variáveis com o primeiro item da lista
    maior = dados[0]
    menor = dados[0]
    
    # Percorre cada valor da lista para encontrar os limites
    for valor in dados:
        if valor > maior:
            maior = valor
        if valor < menor:
    ...
    # Retorna o valor da amplitude
    return maior - menor

# Exemplo de uso com os dados da tabela
